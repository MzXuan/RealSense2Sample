...
# objectPoints = objectPoints*square_size
# print ("opject points: ", objectPoints)
...
for path in glob.glob('./data/data_bc1/color_*.jpg'):
    print (path)
...
with open("./data/calibration.yaml", "w") as f:
    yaml.dump(data, f)
...
# img = cv2.imread('../data/color_14.jpg')
h, w = img.shape[:2]
